...
class AmbrosoVelocityRelaxationCoef(AuxQuantity2Phase):
    ...
    def compute(self, data, der):
        ...
        du_relax_dT2 = (1 - beta) / denominator - (1 - beta) * T2 / denominator / denominator * (
            1 - beta)
        ...
        der[self.name][
            "arhoA1"] = du_relax_dT1 * der["T1"]["arhoA1"] + du_relax_dbeta * der["beta"]["arhoA1"]
        der[self.name][
            "arhoA2"] = du_relax_dT2 * der["T2"]["arhoA2"] + du_relax_dbeta * der["beta"]["arhoA2"]
