...
class InletP0T0BC(OnePhaseBC):
  ...
  def applyWeakBC(self, U, r, J):
    ...
    if not self.strongly_enforce_mass:
      ...
      J[self.i_arhoA, self.i_arhoA] += vf * (self.drho_darhoA * self.u + self.rho * self.du_darhoA) * A * self.nx
      J[self.i_arhoA, self.i_arhouA] += vf * (self.drho_darhouA * self.u + self.rho * self.du_darhouA) * A * self.nx
  ...
  def applyStrongBCNonlinearSystem(self, U, r, J):
    ...
    if self.strongly_enforce_momentum:
      ...
      darhouABC_darhoA = vf * (self.drho_darhoA * self.u**2 + self.rho * 2 * self.u * self.du_darhoA + self.dp_darhoA) * A
      darhouABC_darhouA = vf * (self.drho_darhouA * self.u**2 + self.rho * 2 * self.u * self.du_darhouA + self.dp_darhouA) * A
