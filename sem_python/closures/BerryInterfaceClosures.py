...
class BerryInterfaceClosures(InterfaceClosures):
  ...
  def createAuxQuantities(self):
    aux_list = self.createIndependentPhaseAuxQuantities(0) + self.createIndependentPhaseAuxQuantities(1)
    aux_names = ["BerryInterfacialAreaDensity", "BerryPressureRelaxationCoef",
      "BerryVelocityRelaxationCoef", "BerryInterfacePressureBar",
      "BerryInterfaceVelocityBar", "BerryInterfacePressure", "BerryInterfaceVelocity"]
