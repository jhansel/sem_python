...
class BerryInterfaceVelocityBar(AuxQuantity2Phase):
  ...
  def compute(self, data, der):
    ...
    der[self.name]["arhoEA1"] = der["z1"]["arhoEA1"] * u1 / (z1 + z2) + numerator * ddenominator * der["z1"]["arhoEA1"]
    ...
    der[self.name]["arhoEA2"] = der["z2"]["arhoEA2"] * u2 / (z1 + z2) + numerator * ddenominator * der["z2"]["arhoEA2"]
