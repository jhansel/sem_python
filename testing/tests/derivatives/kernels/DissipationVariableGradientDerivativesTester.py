...
class DissipationVariableGradientDerivativesTester(unittest.TestCase):
    ...
    def test1Phase(self):
        ...
        rel_diffs = self.derivatives_tester.checkDerivatives(
            "DissipationVariableGradient", ModelType.OnePhase, 0, aux, kernel_params=kernel_params)
    ...
    def test2Phase(self):
        ...
        rel_diffs = self.derivatives_tester.checkDerivatives(
            "DissipationVariableGradient", ModelType.TwoPhase, 0, aux, kernel_params=kernel_params)
        for key in rel_diffs:
