...
class InputFileModifierTester(unittest.TestCase):
    ...
    def setUp(self):
        ...
        input_file_modifier.modifySubblockParam(
            "BlockA", "SubblockAA", "subparamAA1", "new_value_subparamAA1")
    ...
    def testSubblockParameterRemoval(self):
        no_subparamAA3 = "subparamAA3" not in self.input_file_parser.subblock_data["BlockA"][
            "SubblockAA"]
    ...
    def testSubblockParameterPreserve(self):
        old_subparamAA2 = self.input_file_parser.subblock_data["BlockA"]["SubblockAA"][
            "subparamAA2"] == "old_value_subparamAA2"
    ...
    def testSubblockParameterChange(self):
        new_subparamAA1 = self.input_file_parser.subblock_data["BlockA"]["SubblockAA"][
            "subparamAA1"] == "new_value_subparamAA1"
